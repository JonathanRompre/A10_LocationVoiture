...
public class ClientsServices {
    ...
    public List<Client> listerClients() { return clientRepository.findAll(); }

    public void ajouterClient(Client client){ clientRepository.save(client); }

    public Client trouverClient(Integer id){ return clientRepository.findById(id).get();}

    public void updateClient(Integer clientId, String nomClient, String prenomClient, String emailClient){
        if(clientRepository.existsById(clientId)){
            Client client = this.trouverClient(clientId);
